...
import com.tranquility.model.ErpData;
...
//        Return d Object
    ...
    public ArrayList<Cookie> extractCookiesMap(Map<String, List<String>> responseHeaders, String[] cookieKeysArray) {
